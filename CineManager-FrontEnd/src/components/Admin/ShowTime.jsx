        ...
        <>
            <div className='pt-10 '>
                <div className='h-12 w-full  flex justify-end'>
                    <button onClick={openAddPopup} className='px-12 rounded-md font-bold mr-40  bg-[#909090]'>Add</button>
                </div>
                            ...
                            <form >
                                ...
                                <div className='mb-4'>
                                    ...
                                    >
                                        ...
                                        <option value="">Salle1</option>
                                        <option value="">Salle2</option>
                                        <option value="">Salle3</option>
                                    </select>
                                </div>
            ...
            {isAddPopupOpen && (
                ...
                <div className='w-full h-screen flex items-center justify-center'>
                    <div className='w-1/3 bg-white p-6 rounded-md relative'>
                        ...
                        <h2 className='text-center font-bold mb-4'>Add New Show Time</h2>
                        <form >
                                <div className='mb-4'>
                                    <label>Date/Hour</label>
                                    <input
